...
down_revision: Union[str, Sequence[str], None] = '37082be2f44b'
...
def upgrade() -> None:
    ...
    op.add_column('products', sa.Column('sale_price', sa.Numeric(precision=38, scale=2), nullable=True))
    op.add_column('products', sa.Column('rating', sa.Numeric(precision=38, scale=2), nullable=True))
    ...
    op.add_column('products', sa.Column('image_src', sa.String(length=255), nullable=True))
